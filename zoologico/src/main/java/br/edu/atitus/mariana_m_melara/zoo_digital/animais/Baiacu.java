...
public class Baiacu extends Peixes implements Nadador, Predador {
    public Baiacu(String nome, int idade, String tipoAgua) {
    ...
    @Override
    public void cacar() {
        System.out.println(this.getNome() + " está caçando pequenos peixes.");
    }
}
